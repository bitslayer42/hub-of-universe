...
///////main////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
function main(imageProj) {
  //imageProj is a RasterProjAEQD
  startup(imageProj), // sets up canvas, webgl, and hammer, and calls init
...
function animation() {
  ...
  if (null != viewStatus.interpolater) {
    ...
    viewStatus.interpolater = Interpolater.create(
      f,
      g,
      e,
      [0, 0],
